 ...
 * This file demonstrates how to integrate Hingenexus with a web frontend
 */

// For React/Vue/Angular applications
export class HingenexusClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HingenexusClient(provider, contractAddress);
